...
[![Anaconda](https://anaconda.org/conda-forge/scores/badges/version.svg)](https://anaconda.org), ki vključuje oboje in tudi večino knjižnic uporabljenih v primerih. 

OPOMBA: V primerih so uporabljene tudi nekatere knjižnice, ki niso del standardne distribucije Python ali knjižnic vključenih v distribuciji Anaconda. Te si uporabnik namesti s pip ali conda programi za namestitev Python knjižnic.
